...
SETTING_FIELDS = [
    ...
    SettingField("skiddle_api_key", "Skiddle API key", "event_data_apis", True, "SKIDDLE_API_KEY"),
    SettingField("skiddle_city_id", "Skiddle city ID", "event_data_apis", False, "SKIDDLE_CITY_ID", ""),
    SettingField("skiddle_api_base_url", "Skiddle approved API/feed URL", "event_data_apis", False, "SKIDDLE_API_BASE_URL", ""),
    SettingField("skiddle_source_settings", "Skiddle source settings", "event_data_apis", False, "SKIDDLE_SOURCE_SETTINGS"),
    SettingField("manual_events_csv_path", "Manual CSV import path", "event_data_apis", False, "MANUAL_EVENTS_CSV_PATH", ""),
